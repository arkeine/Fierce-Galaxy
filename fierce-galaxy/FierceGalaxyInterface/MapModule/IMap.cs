namespace FierceGalaxyInterface
{
    ...
    public interface IMap : IReadOnlyMap
    {
        ...
        void SetSpawnNode(IReadOnlyNode node, bool isSpawn);
        ...
        void AddLink(IReadOnlyNode node1, IReadOnlyNode node2);
        ...
        /// </summary>
        /// <returns>True if the link was added, false otherwise</returns>
        void RemoveLink(IReadOnlyNode node1, IReadOnlyNode node2);
    }
}
